class Room3 extends Phaser.Scene {
    ...
    create() {
        ...
        this.bgRight = new Block(this, -32 , -32, 'whiteTile', undefined, 34, 28, true, this.landGroup);
        new Block(this, 4 * this.pixelSize, 23 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
        new Block(this, 10 * this.pixelSize, 23 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
        new Block(this, 16 * this.pixelSize, 23 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
        new Block(this, 22 * this.pixelSize, 23 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
        new Block(this, 28 * this.pixelSize, 23 * this.pixelSize, 'whiteTile', undefined, 4, 1, true, this.landGroup);
        new Block(this, 4 * this.pixelSize, 18 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
        new Block(this, 10 * this.pixelSize, 18 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
        new Block(this, 16 * this.pixelSize, 18 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
        new Block(this, 22 * this.pixelSize, 18 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
        new Block(this, 28 * this.pixelSize, 18 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
        new Block(this, 4 * this.pixelSize, 13 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
        new Block(this, 10 * this.pixelSize, 13 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
        new Block(this, 16 * this.pixelSize, 13 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
        new Block(this, 22 * this.pixelSize, 13 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
        new Block(this, 28 * this.pixelSize, 13 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
        new Block(this, 4 * this.pixelSize, 8 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
        new Block(this, 10 * this.pixelSize, 8 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
        new Block(this, 16 * this.pixelSize, 8 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
        new Block(this, 22 * this.pixelSize, 8 * this.pixelSize, 'whiteTile', undefined, 1, 1, true, this.landGroup);
