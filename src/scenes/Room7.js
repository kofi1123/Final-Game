class Room7 extends Phaser.Scene {
    ...
    create() {
        ...
        this.text = this.add.text(game.config.width/2 + 1 * this.pixelSize, 2 * this.pixelSize, 'L7 - This Looks Familiar...', {fontSize: '25px'}).setOrigin(0.5).setScrollFactor(0);
        this.door1 = new Door(this, 206 * this.pixelSize, 6 * this.pixelSize, 'door', undefined, 'credits', 2).setOrigin(0,0);
        this.player = new Player(this, 2 * this.pixelSize, 7 * this.pixelSize, 'player', undefined).setOrigin(0,0);
